...
DJ_CHANNEL_L = int(os.environ.get("DJ_CHANNEL_L", 1))
DJ_CHANNEL_R = int(os.environ.get("DJ_CHANNEL_R", 2))
SHUFFLE_CHANNEL_L = int(os.environ.get("SHUFFLE_CHANNEL_L", 3))
SHUFFLE_CHANNEL_R = int(os.environ.get("SHUFFLE_CHANNEL_R", 4))
